...
try {
        ...
        s_sql = "select board_number,subject,name,from_unixtime(writetime,'%Y/%m/%d'),count,email from bbs order by board_number desc limit "+i_offset+","+i_list_num;  
        // 목록 조회를 위한 SQL 문
...
%>
    ...
    <tr>
        ...
        <td width=490>
            <a href="view.jsp?page=<%= i_page %>&board_number=<%= i_number %>"><%=s_subject %></a>
        </td>
        <td width=60>
