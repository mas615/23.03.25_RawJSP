...
<% 
rs2 = stmt2.executeQuery("select * from bbs2 where board_number=" + num);
...
<% if (curUser != null && writer != null && writer.equals(curUser)) { %>
    <a href="action/xss2_delete_action.jsp?majun='<%= num %>'" role="button" class="btn btn-primary">글삭제</a>
	<button type="button" class="btn btn-primary">글수정(준비중)</button>
<% }; %>
	<a href="xss2_board.jsp" role="button" class="btn btn-primary">목록보기</a>	
</div>
</div>
<div class="col">
</div>
