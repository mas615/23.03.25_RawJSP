...
<div class="container text-center">
    <div class="row">
              <div class="col">
                  ...
                  if(session.getAttribute("userID") != null ){
                    out.println("<a href=\"xss2_write.jsp\" role=\"button\" class=\"btn btn-primary\">글쓰기</a>");
                  }else{
    ...
    <table class="table table-striped table-hover">
      ...
      <%
      if(search != null){
        ResultSet rs3 = stmt2.executeQuery("select * from bbs2 where subject LIKE'%"+search+"%' order by writetime DESC");
        while (rs3.next()) {
          out.println("<tr>");
          out.println("<td>" + rs3.getInt("board_number") + "</td>");
          out.println("<td>" + "<a href='xss2_show.jsp?num=" + rs3.getInt("board_number") + "'>" + rs3.getString("subject") + "</a>" + "</td>");
      ...
      conn2.close();
        ...
        ResultSet rs3 = stmt2.executeQuery("select * from bbs2 order by writetime DESC");
        while (rs3.next()) {
          out.println("<tr>");
          out.println("<td>" + rs3.getInt("board_number") + "</td>");
          out.println("<td>" + "<a href='xss2_show.jsp?num=" + rs3.getInt("board_number") + "'>" + rs3.getString("subject") + "</a>" + "</td>");
