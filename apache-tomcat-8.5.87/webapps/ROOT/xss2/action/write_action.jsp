...
s_memo = s_memo.replace("<script>", "noscript").replace("</script>", "noscript");
...
try {
	...
	String str_sql = "INSERT INTO XSS2 (name,password,email,HOMEPAGE,subject,memo,ip,writetime) VALUES(?,?,?,?,?,?,?,TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'))";
