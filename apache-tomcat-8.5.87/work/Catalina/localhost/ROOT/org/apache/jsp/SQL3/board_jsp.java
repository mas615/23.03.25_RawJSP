 ...
 * Generated at: 2023-04-03 08:24:59 UTC
...
public final class board_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/SQL3/action/../../action/globalip.jsp", Long.valueOf(1680494978293L));
    _jspx_dependants.put("/SQL3/action/../../action/conn_db.jsp", Long.valueOf(1680494866716L));
 ...
 if(search != null){ 
      ...
      out.write("        ");
        ...
        if(search != null){    
          ...
          while (rs3.next()) {
            out.println("<tr>");
            out.println("<td>s" + rs3.getInt("board_number") + "</td>");
            out.println("<td>s" + "<a href='show.jsp?num=" + rs3.getInt("board_number") + "'>" + rs3.getString("subject") + "</a>" + "</td>");
            out.println("<td>s" + rs3.getString("name") + "</td>");
            out.println("<td>s" + rs3.getString("writetime") + "</td>");
            out.println("</tr>");
        }
        rs3.close();
        stmt2.close();
